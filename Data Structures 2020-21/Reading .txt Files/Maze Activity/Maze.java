...
public class Maze extends JPanel implements KeyListener {
        ...
        try {
            ...
            while ((text = input.readLine()) != null) {
                for (int c = 0; c < text.length(); c++) {
                    ...
                    if (text.charAt(c) == 'R' || text.charAt(c) == 'D' || text.charAt(c) == 'L' || text.charAt(c) == 'U') {
                        startRow = r;
                        startCol = c;
    ...
    public void paintComponent(Graphics g) {
        ...
        if (!render3D) {
            ...
            wallList.add(new Wall(rows, cols, Color.BLACK, 50, "W"));
    ...
    public Wall getLeftCeiling(int fov) {
        ...
        if (currentBrightness >= 0)
            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "LC");
        else
            return new Wall(rows, cols, 0, 0, 0, 50, "LC");
    }
    ...
    public Wall getRightCeiling(int fov) {
        ...
        int currentBrightness = player.getBrightness() - 50 * fov;
        if (currentBrightness >= 0)
            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "RC");
        else
            return new Wall(rows, cols, 0, 0, 0, 50, "RC");
    }
    ...
    public Wall getCeiling(int fov) {
        ...
        int currentBrightness = player.getBrightness() - 50 * fov;
        if (currentBrightness >= 0)
            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "C");
        else
            return new Wall(rows, cols, 0, 0, 0, 50, "C");
    }
    ...
    public Wall getLeftFloor(int fov) {
        ...
        int currentBrightness = player.getBrightness() - 50 * fov;
        if (currentBrightness >= 0)
            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "LF");
        else
            return new Wall(rows, cols, 0, 0, 0, 50, "LF");
    }
    ...
    public Wall getRightFloor(int fov) {
        ...
        int currentBrightness = player.getBrightness() - 50 * fov;
        if (currentBrightness >= 0)
            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "RF");
        else
            return new Wall(rows, cols, 0, 0, 0, 50, "RF");
    }
    ...
    public Wall getFloor(int fov) {
                ...
                switch (player.getDirection()) {
                    case 0:
                        if (mazeArr[r - fov][c] == 'B')
                            return new Wall(rows, cols, currentBrightness, currentBrightness, 0, 50, "F");
                        else if (mazeArr[r - fov][c] == 'E')
                            return new Wall(rows, cols, 0, currentBrightness, 0, 50, "F");
                        else
                            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "F");
                    case 1:
        ...
        return new Wall(rows, cols, 0, 0, 0, 50, "F");
    }
    ...
    public Wall getLeftWall(int fov) {
        ...
        int currentBrightness = player.getBrightness() - 50 * fov;
        if (currentBrightness >= 0)
            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "LW");
        else
            return new Wall(rows, cols, 0, 0, 0, 50, "LW");
    }
    ...
    public Wall getRightWall(int fov) {
        ...
        int currentBrightness = player.getBrightness() - 50 * fov;
        if (currentBrightness >= 0)
            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "RW");
        else
            return new Wall(rows, cols, 0, 0, 0, 50, "RW");
    }
    ...
    public Wall getWall(int fov) {
        ...
        int currentBrightness = player.getBrightness() - 50 * fov;
        if (currentBrightness >= 0)
            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "W");
        else
            return new Wall(rows, cols, 0, 0, 0, 50, "W");
    }
    ...
    public Wall getLeftPathway(int fov) {
        ...
        if (currentBrightness >= 0)
            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "LP");
        else
            return new Wall(rows, cols, 0, 0, 0, 50, "LP");
    }
    ...
    public Wall getRightPathway(int fov) {
        ...
        int currentBrightness = player.getBrightness() - 50 - 50 * fov;
        if (currentBrightness >= 0)
            return new Wall(rows, cols, currentBrightness, currentBrightness, currentBrightness, 50, "RP");
        else
            return new Wall(rows, cols, 0, 0, 0, 50, "RP");
    }
}